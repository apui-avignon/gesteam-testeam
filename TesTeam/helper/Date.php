...
class Date
{
    ...
    function getDayOfEvaluation($start_date, $period, $date)
    {
    ...
    function dateCalculation($course_parameters, $last_date, $nb_of_week = 15)
    {
        ...
        if ($last_date == $today) {
            $last_evaluation_date = $this->getDayOfEvaluation($course_parameters['start_date'], $course_parameters['period'], $last_date);
        } else {
